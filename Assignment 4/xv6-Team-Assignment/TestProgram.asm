...
_TestProgram:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  11:	00 
  12:	c7 04 24 56 07 00 00 	movl   $0x756,(%esp)
  19:	e8 c4 02 00 00       	call   2e2 <open>
      printf(1,"Test program %d\n",x);
  1e:	c7 44 24 04 64 07 00 	movl   $0x764,0x4(%esp)
  25:	00 
...
main(int argc, char *argv[])
{
  ...
  3c:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
  43:	00 
...
main(int argc, char *argv[])
{
      ...
      printf(1,"Test program %d\n",x);
      char buffer[5] = {'a','b','c','d','b'};
  4b:	c6 44 24 1b 61       	movb   $0x61,0x1b(%esp)
  50:	c6 44 24 1c 62       	movb   $0x62,0x1c(%esp)
  55:	c6 44 24 1d 63       	movb   $0x63,0x1d(%esp)
  5a:	c6 44 24 1e 64       	movb   $0x64,0x1e(%esp)
  5f:	c6 44 24 1f 62       	movb   $0x62,0x1f(%esp)
      write(x, &buffer,5);
  64:	e8 59 02 00 00       	call   2c2 <write>
      close (x);
  69:	89 1c 24             	mov    %ebx,(%esp)
  6c:	e8 59 02 00 00       	call   2ca <close>
      exit();
  71:	e8 2c 02 00 00       	call   2a2 <exit>
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 75 07 00 00       	mov    $0x775,%eax
