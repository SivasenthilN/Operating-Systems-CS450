...
_TestProgram1:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  33:	e8 a8 04 00 00       	call   4e0 <printf>
      ...
      write(x, &buffer,52);
  38:	8d 44 24 1c          	lea    0x1c(%esp),%eax
int
main(int argc, char *argv[])
{
      int x = open("smallfile1.txt", O_CREATE|O_WRONLY|O_SFILE);
      printf(1,"Test program %d\n",x);
      char buffer[52] = {'a','b','c','d','b','c','b','c','d','b','c','d','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d'};
  3c:	c6 44 24 1c 61       	movb   $0x61,0x1c(%esp)
  41:	c6 44 24 1d 62       	movb   $0x62,0x1d(%esp)
  46:	c6 44 24 1e 63       	movb   $0x63,0x1e(%esp)
  4b:	c6 44 24 1f 64       	movb   $0x64,0x1f(%esp)
  50:	c6 44 24 20 62       	movb   $0x62,0x20(%esp)
  55:	c6 44 24 21 63       	movb   $0x63,0x21(%esp)
  5a:	c6 44 24 22 62       	movb   $0x62,0x22(%esp)
  5f:	c6 44 24 23 63       	movb   $0x63,0x23(%esp)
  64:	c6 44 24 24 64       	movb   $0x64,0x24(%esp)
  69:	c6 44 24 25 62       	movb   $0x62,0x25(%esp)
  6e:	c6 44 24 26 63       	movb   $0x63,0x26(%esp)
  73:	c6 44 24 27 64       	movb   $0x64,0x27(%esp)
  78:	c6 44 24 28 64       	movb   $0x64,0x28(%esp)
  7d:	c6 44 24 29 62       	movb   $0x62,0x29(%esp)
  82:	c6 44 24 2a 63       	movb   $0x63,0x2a(%esp)
  87:	c6 44 24 2b 64       	movb   $0x64,0x2b(%esp)
  8c:	c6 44 24 2c 62       	movb   $0x62,0x2c(%esp)
  91:	c6 44 24 2d 63       	movb   $0x63,0x2d(%esp)
  96:	c6 44 24 2e 64       	movb   $0x64,0x2e(%esp)
  9b:	c6 44 24 2f 62       	movb   $0x62,0x2f(%esp)
  a0:	c6 44 24 30 63       	movb   $0x63,0x30(%esp)
  a5:	c6 44 24 31 64       	movb   $0x64,0x31(%esp)
  aa:	c6 44 24 32 62       	movb   $0x62,0x32(%esp)
  af:	c6 44 24 33 63       	movb   $0x63,0x33(%esp)
  b4:	c6 44 24 34 64       	movb   $0x64,0x34(%esp)
  b9:	c6 44 24 35 62       	movb   $0x62,0x35(%esp)
  be:	c6 44 24 36 63       	movb   $0x63,0x36(%esp)
  c3:	c6 44 24 37 64       	movb   $0x64,0x37(%esp)
  c8:	c6 44 24 38 62       	movb   $0x62,0x38(%esp)
  cd:	c6 44 24 39 63       	movb   $0x63,0x39(%esp)
  d2:	c6 44 24 3a 64       	movb   $0x64,0x3a(%esp)
  d7:	c6 44 24 3b 62       	movb   $0x62,0x3b(%esp)
  dc:	c6 44 24 3c 63       	movb   $0x63,0x3c(%esp)
  e1:	c6 44 24 3d 64       	movb   $0x64,0x3d(%esp)
      write(x, &buffer,52);
  e6:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
  ed:	00 
...
main(int argc, char *argv[])
{
      ...
      printf(1,"Test program %d\n",x);
      char buffer[52] = {'a','b','c','d','b','c','b','c','d','b','c','d','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d','b','c','d'};
  f5:	c6 44 24 3e 62       	movb   $0x62,0x3e(%esp)
  fa:	c6 44 24 3f 63       	movb   $0x63,0x3f(%esp)
  ff:	c6 44 24 40 64       	movb   $0x64,0x40(%esp)
 104:	c6 44 24 41 62       	movb   $0x62,0x41(%esp)
 109:	c6 44 24 42 63       	movb   $0x63,0x42(%esp)
 10e:	c6 44 24 43 64       	movb   $0x64,0x43(%esp)
 113:	c6 44 24 44 62       	movb   $0x62,0x44(%esp)
 118:	c6 44 24 45 63       	movb   $0x63,0x45(%esp)
 11d:	c6 44 24 46 64       	movb   $0x64,0x46(%esp)
 122:	c6 44 24 47 62       	movb   $0x62,0x47(%esp)
 127:	c6 44 24 48 63       	movb   $0x63,0x48(%esp)
 12c:	c6 44 24 49 64       	movb   $0x64,0x49(%esp)
 131:	c6 44 24 4a 62       	movb   $0x62,0x4a(%esp)
 136:	c6 44 24 4b 63       	movb   $0x63,0x4b(%esp)
 13b:	c6 44 24 4c 64       	movb   $0x64,0x4c(%esp)
 140:	c6 44 24 4d 62       	movb   $0x62,0x4d(%esp)
 145:	c6 44 24 4e 63       	movb   $0x63,0x4e(%esp)
 14a:	c6 44 24 4f 64       	movb   $0x64,0x4f(%esp)
      write(x, &buffer,52);
 14f:	e8 5e 02 00 00       	call   3b2 <write>
      close (x);
 154:	89 1c 24             	mov    %ebx,(%esp)
 157:	e8 5e 02 00 00       	call   3ba <close>
      exit();
 15c:	e8 31 02 00 00       	call   392 <exit>
